...
reference(engine::textureManager->empty())
{
...
reference(_reference_image)
{
    ...
    else
    {
        ...
        //engine::textureManager->save_png(ref_resized,"imp");
...
double ImpostorMetric::get(GrovePacked &g)
{
    ...
    else
    {
        ...
        float av_m = 0;
        //engine::textureManager->save_png(imp,"imp");
        ...
        //engine::textureManager->save_png_raw(reference_raw,w,h,4,"imp");
        //tard.clear();
        for (int i=0;i<3;i++)
        {
            for (int j=0;j<3;j++)
        ...
        engine::textureManager->save_png_raw(imp_raw,iw,ih,4,"imp");
        //engine::textureManager->save_png(imp,"imp");
        av_m /= 8;
