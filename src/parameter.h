...
struct TreeStructureParameters
{
    ...
    TreeStructureParameters() : max_depth(4),
                                ...
                                gravitrop(1, std::vector<float>{5, 1, 1, 0.75, 0.25}, REGENERATE_ON_GET, new Uniform(-0.1, 0.1), 0.1, 10),

                                seg_dir_conserv(10, std::vector<float>{30, 15, 10, 10, 20}, REGENERATE_ON_GET, new Uniform(-0.05, 0.05), 0, 1000),
                                ...
                                base_branch_feed(300, std::vector<float>{800, 350, 200, 70, 200}, REGENERATE_ON_GET, new Uniform(-200, 200)),
                                base_seg_feed(100, std::vector<float>{200, 150, 120, 70, 50}, REGENERATE_ON_GET, new Uniform(-30, 30)),
                                ...
                                min_branching_chance(0, std::vector<float>{-0.25, 0, 0.67, 0.75, 0.7}),
