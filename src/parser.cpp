...
int parser_main(int argc, char *argv[])
{
    ...
    if (demo_mode)
    {
      ...
      int cnt = 0;
      float dist = 75;
      int t_id = metainfoManager.get_tree_type_id_by_name("simpliest_tree_default");
      int b_id = metainfoManager.get_tree_type_id_by_name("simpliest_tree_default");
      int l_id = metainfoManager.get_tree_type_id_by_name("simpliest_tree_default");
