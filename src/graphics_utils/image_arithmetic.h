...
public:
 ...
 static void minimum(Texture &I, Texture &I_1, Texture &I_2, float a, float b); //I = min(a*I_1, b*I_2)
 static void maximum(Texture &I, Texture &I_1, Texture &I_2, float a, float b); //I = max(a*I_1, b*I_2)
};
