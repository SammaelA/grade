...
*/
  ...
  std::vector<SdfNodeProperties> node_properties = 
  {
    ...
    {SdfNodeType::CIRCLE       , "Circle"       , 1, 0, {[](SdfNodeType::Type t) -> SdfNode* {return new Circle2DSdfNode(t);}}},
    {SdfNodeType::QUAD         , "Quad"         , 2, 0, {[](SdfNodeType::Type t) -> SdfNode* {return new Quad2DSdfNode(t);}}},
    {SdfNodeType::EXTRUSION    , "Extrusion"    , 1, 1, {[](SdfNodeType::Type t) -> SdfNode* {return new ExtrusionSdfNode(t);}}},
