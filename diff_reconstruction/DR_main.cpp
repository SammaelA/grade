...
int main(int argc, char **argv)
{
  ...
  else if (argc >= 3 && std::string(argv[2]) == "-demo")
  {
    MitsubaInterface mi("scripts", "mitsuba_optimization_embedded");
  {
    std::vector<float> params= { 2.678909, 3.034878, 3.695173, 3.826595, 4.01021, 4.271101, 4.252821, 4.553301, 4.631008, 0.879079, 1.000000, 0.037779, 0.546789, 0.120683, 0.217053, 0.171038, 0.191508, 0.233003, 0.234107, 0.192667, 0.175451, 0.231858, 0.203609, 0.186131, 0.192067, 0.122155, 0.144015, 0.157416, 0.149036, 0.127017, 0.169588, 0.144001, 0.210640, 1.052707, 1.105030, 1.863986, 1.392405, 0.832115, 0.618925, 0.927055, 0.872564, 0.599927, 0.757641, 0.751858, 0.888729, 0.893978, 0.729114, 0.534959, 0.568148, 0.580093, 0.500000, 1.250672, 1.997790, 0.074973, 0.562698, 0.538676, 0.016610, 0.238621, 0.011962, 0.000000, 0.500000, 662.898010, 1.000000, 79.108002, 0.200000, 0.500000 };
