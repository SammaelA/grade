...
namespace u_g
{
  ...
  u_g::vec3 norm(u_g::vec3 v)//right and up -> at screen
  {
    return dgen::normalize_with_default(v, u_g::vec3(1,0,0));
  }

  u_g::mat43 get_any_rot_mat(u_g::vec3 axis, my_float angle)
  {
    vec3 ax = norm(axis);
