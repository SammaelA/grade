...
void TensorProcessorImpl_GPU::AllocateAllDescriptorSets()
{
  ...
  buffersSize.descriptorCount          = 22 + 64; // + 64 for reserve
  ...
  descriptorPoolCreateInfo.maxSets       = 20 + 2; // add 1 to prevent zero case and one more for internal needs
  ...
  descriptorSetAllocateInfo.descriptorSetCount = 20;     
