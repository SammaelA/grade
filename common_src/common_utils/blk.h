...
struct Block
{
    ...
    glm::vec2 get_vec2(int id, glm::vec2 base_val = glm::vec2(0, 0)) const;
    glm::vec3 get_vec3(int id, glm::vec3 base_val = glm::vec3(0, 0, 0)) const;
    glm::vec4 get_vec4(int id, glm::vec4 base_val = glm::vec4(0, 0, 0, 0)) const;
    glm::ivec2 get_ivec2(int id, glm::ivec2 base_val = glm::ivec2(0, 0)) const;
    glm::ivec3 get_ivec3(int id, glm::ivec3 base_val = glm::ivec3(0, 0, 0)) const;
    glm::ivec4 get_ivec4(int id, glm::ivec4 base_val = glm::ivec4(0, 0, 0, 0)) const;
    glm::mat4 get_mat4(int id, glm::mat4 base_val = glm::mat4(1.0f)) const;
    ...
    glm::vec2 get_vec2(const std::string name, glm::vec2 base_val = glm::vec2(0, 0)) const;
    glm::vec3 get_vec3(const std::string name, glm::vec3 base_val = glm::vec3(0, 0, 0)) const;
    glm::vec4 get_vec4(const std::string name, glm::vec4 base_val = glm::vec4(0, 0, 0, 0)) const;
    glm::ivec2 get_ivec2(const std::string name, glm::ivec2 base_val = glm::ivec2(0, 0)) const;
    glm::ivec3 get_ivec3(const std::string name, glm::ivec3 base_val = glm::ivec3(0, 0, 0)) const;
    glm::ivec4 get_ivec4(const std::string name, glm::ivec4 base_val = glm::ivec4(0, 0, 0, 0)) const;
    glm::mat4 get_mat4(const std::string name, glm::mat4 base_val = glm::mat4(1.0f)) const;
